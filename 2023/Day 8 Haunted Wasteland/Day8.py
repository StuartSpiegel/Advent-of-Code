...
#         node_name, connections_str = parts

#         # Handle leaf nodes (e.g., DQS = (CCN, PNF))
#         if connections_str.startswith("("):
#             connections = tuple(connections_str[1:-1].replace(" ", "").split(","))
#         else:
#             connections = (connections_str,)

#         node_dict[node_name] = connections
...
#     node_dict = parse_input(input_str)
