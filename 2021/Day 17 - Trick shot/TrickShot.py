...
def solve():
    with open("input.txt") as f:
        ...
        y1 = int(input[3][2:5])
        y2 = int(input[3][5:10])
        # maxh = max_height(min(y1, y2)) # MINI-MAX Alg
        # print("Max height is:", maxh)
        maxy = max(abs(y1), abs(y2))
        positions = 0 #counter holds the number of positions (x, y) that will land in target area - Part 2
...
def land_in_area(velocity, x1, x2,y1, y2):
    pos = [0, 0]
