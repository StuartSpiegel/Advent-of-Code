# --- Day 1: Sonar Sweep --- You're minding your own business on a ship at sea when the overboard alarm goes off! You
# rush to see if you can help. Apparently, one of the Elves tripped and accidentally sent the sleigh keys flying into
# the ocean!
#
...
#
# 199 200 208 210 200 207 240 269 260 263 This report indicates that, scanning outward from the submarine,
...
# We are using a sliding window of length 3
# Group B is a one off increment of Group A and these groups are now the comparator elements
